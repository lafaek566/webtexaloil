...
import commentImg from '../assets/all-images/7.jpg';
    ...
    <Helmet title={blog.title}>
      ...
      <Container>
        <Row>
            ...
            <div className="comment__list mt-5">
              <h4>3 Comments</h4>
               ...
               <div className="comment__content">
                  <h6 className="fw-bold">Igi</h6>
                  <p className="section__description mb-0">14 july, 2023</p>
                  <p className="section__description">dengan menggunakan Texal Oil , banyak keuntungan yang
                  didapatkan dari menjaga bagian keseluruhan mesin.</p>
                ...
                <div className="leave__comment-form mt-5"></div>
                <h4>Leave Comment</h4>
          ...
          <Col lg="4" md="4">
            <div className="recent__post m-4">
            ...
            {blogData.map((item) => (
                <div className="recent__blog-post mb-4" key={item.id}>
                  <div className="recent__blog-item d-flex gap-3">
                    ...
                    <h6>
                      <Link to={`/blogs/${item.title}`}>{blog.title}
                      </Link>
                    </h6>
                  </div>
                </div>
