              ...
              <div className="car__info">
                ...
                mt-3">
                  <h6 className="rent__price fw-bold fs-4">
                    IDR{singleCarItem.price}.000/liter
                    </h6>
                ...
                <div
                    className=" d-flex align-items-center mt-3" 
                      ...
                      section__description">
                        ...
                        <span className=" d-flex align-items-center gap-1 
                      section__description">
                        <i class="ri-roadster-line" style={{color:'#f9a826'}}></i>{singleCarItem.automatic}
                        </span>

                        <span className=" d-flex align-items-center gap-1 
                      section__description">
                        <i class="ri-oil-line" style={{color:'#f9a826'}}></i>{singleCarItem.speed}
                        </span>
                    </div>
          ...
          {/* 
            ...
            <Col lg="5" className="mt-5">
              <div className="payment__info mt-5">
                <h5 className="mb-4 fw-bold">Click "Book Now" to buy</h5>
                <PaymentMethod />
              </div>
            </Col>
                  */}
